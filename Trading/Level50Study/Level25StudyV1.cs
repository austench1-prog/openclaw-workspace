...
// Version: 1.0 | 2026-06-25 | Dragon
//
// STUDY: When price retraces to Level25, does it hit ImpulseHigh (UP) or ImpulseLow (DOWN) first?
...
{
    public class Level25StudyV1 : Strategy
    {
        // ---- CSV output -------------------------------------------------------
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Description  = "NQ Level25 Study v1 - trigger=L25 UP=High DOWN=Low - no orders";
                Name         = "Level25StudyV1";
            ...
            else if (State == State.DataLoaded)
            {
                ...
                _csv5mPath  = Path.Combine(dir, "Level25Study_5m_"  + ts + ".csv");
                _csv15mPath = Path.Combine(dir, "Level25Study_15m_" + ts + ".csv");
        ...
        private void Check(ref Evt ev, string tf, double bH, double bL, DateTime bT)
        {
            ...
            // UP = breaks ImpulseHigh, DOWN = touches ImpulseLow
            bool hitH   = bH > ev.H;
            bool hitLow = bL <= ev.L;

            string outcome = null;
            if      (hitH && hitLow) outcome = "AMBIGUOUS";
            else if (hitH)           outcome = "UP";
            else if (hitLow)         outcome = "DOWN";
        ...
        private void WriteSummary()
        {
            ...
            {
                sw.WriteLine("=================================================================");
                sw.WriteLine("  NQ LEVEL25 STUDY v1 -- trigger=L25 UP=High DOWN=Low");
                ...
                sw.WriteLine(string.Format(f, "Median min to Low touch (DOWN)",
            ...
            List<double> tUp, List<double> tDn, List<double> rngs)
        {
            ...
            sw.WriteLine("    Median min to Low:   " + (tDn.Count > 0 ? Med(tDn).ToString("F1") : "N/A"));
